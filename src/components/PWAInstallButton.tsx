...
export const PWAInstallButton: React.FC<PWAInstallButtonProps> = ({
  ...
  if (isInstalled || justInstalled) {
    return (
      <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-950/70 border border-emerald-500/40 text-emerald-400 text-xs font-semibold select-none">
